    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
          ...
          <a href="https://www.instagram.com/" target="_blank" rel="noopener" style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: '#E1306C', color: '#fff', borderRadius: '6px', padding: '5px 12px', fontSize: '12px', fontWeight: 600, textDecoration: 'none' }}>Instagram</a>
          <a href={`fb-messenger://share/?link=${encodeURIComponent(pageUrl)}`} target="_blank" rel="noopener" style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: '#00B2FF', color: '#fff', borderRadius: '6px', padding: '5px 12px', fontSize: '12px', fontWeight: 600, textDecoration: 'none' }}>Messenger</a>
