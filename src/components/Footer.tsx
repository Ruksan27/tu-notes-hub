      ...
      .then(data => {
        if (data?.settings) {
          setSocials({
            ...
            github: data.settings.githubLink || DEFAULTS.github,
            linkedin: data.settings.linkedinLink || DEFAULTS.linkedin,
          })
        }
      })
      .catch(() => {})
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
              ...
              <a
                ...
                style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: '#e6edf3', textDecoration: 'none', transition: 'all 0.2s',
                }}
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                ...
                style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: '#0A66C2', textDecoration: 'none', transition: 'all 0.2s',
                }}
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
