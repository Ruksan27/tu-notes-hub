...
const Widget = ({ mainDashboard = mainDashboardData }: WidgetProps) => {
  return (
    <div className="w-full">
      <div className="w-full">
        <Card className="p-0 ring-0 border rounded-2xl relative h-full max-w-full w-full mx-auto overflow-hidden bg-card text-card-foreground shadow-sm">
